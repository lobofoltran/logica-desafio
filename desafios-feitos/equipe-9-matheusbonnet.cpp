...
int main () {
	...
	if (salario < 1900) {
		std::cout	<< std::endl << "Imposto cobrado (0% de imposto): " << "0" << std::endl; // Neste exemplo a Fórmula de Salário será sempre 0.
		std::cout	<< "Salario (sem imposto): " << salario; 				 // Quando o salário for menor que 1900, não haverá cobrança de impostos.
		...
		std::cout	<< std::endl << "Imposto cobrado (2% de imposto): " << salarioForm; 	// Resultado da Fórmula de porcentagem.
		std::cout	<< << std::endl << "Salario (-2% de imposto): " << salarioForm2; 	// Resultado da Fórmula de Salário menos Porcentagem de imposto.
	} else if (salario >= 2500 && salario < 3700) {
		salarioForm = ( salario * 3 ) / 100;
		salarioForm2 = salario - salarioForm;
		std::cout	<< std::endl << "Imposto cobrado (3% de imposto): " << salarioForm << std::endl;
		std::cout	<< "Salario (-3% de imposto): " << salarioForm2;
	} else if (salario >= 3700 && salario < 5000) {
		salarioForm = ( salario * 4.5 ) / 100;
		salarioForm2 = salario - salarioForm;
		std::cout	<< std::endl << "Imposto cobrado (4.5% de imposto): " << salarioForm << std::endl;
		std::cout	<< "Salario (-4.5% de imposto): " << salarioForm2;
	} else if (salario >= 5000) {
		salarioForm = ( salario * 6 ) / 100;
		salarioForm2 = salario - salarioForm;
		std::cout	<< std::endl << "Imposto cobrado (6% de imposto): " << salarioForm << std::endl;
